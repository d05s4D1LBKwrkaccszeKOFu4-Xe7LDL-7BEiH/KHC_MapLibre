    ...
    if (content === '') {
        content = '<div class="popup-row">Нет данных по району</div>';
            ...
            if (currentLevel === 'settlement' && title && title.toUpperCase().includes('КОСТАНАЙ')) {
                footer = `<div style="margin-top:10px; text-align:center;"><a href="https://d05s4D1LBKwrkaccszeKOFu4-Xe7LDL-7BEiH.github.io/kostY5_JYrviDpanay/" target="_blank" class="popup-btn-link">Перейти к карте Костаная</a></div>`;
            }
        }
